...
FINAL_CFLAGS_linux_64="-march=nocona -mtune=haswell -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe"
FINAL_CFLAGS_linux_ppc64le="-mcpu=power8 -mtune=power8 -fPIC -fstack-protector-strong -fno-plt -O3 -pipe"
FINAL_CFLAGS_linux_aarch64="-fPIC -fstack-protector-strong -fno-plt -O3 -pipe"
FINAL_CFLAGS_linux_s390x="-fPIC -fstack-protector-strong -fno-plt -O3 -pipe"
FINAL_CFLAGS_win_64="-fPIC -fstack-protector-strong -fno-plt -O3 -pipe"

FINAL_CXXFLAGS_linux_64="-fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -march=nocona -mtune=haswell -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe"
FINAL_CXXFLAGS_linux_ppc64le="-fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -mcpu=power8 -mtune=power8 -fPIC -fstack-protector-strong -fno-plt -O3 -pipe"
FINAL_CXXFLAGS_linux_aarch64="-fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -fPIC -fstack-protector-strong -fno-plt -O3 -pipe"
FINAL_CXXFLAGS_linux_s390x="-fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -fPIC -fstack-protector-strong -fno-plt -O3 -pipe"
FINAL_CXXFLAGS_win_64="-fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -fPIC -fstack-protector-strong -fno-plt -O3 -pipe"

FINAL_FFLAGS_linux_64="-fopenmp -march=nocona -mtune=haswell -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe"
FINAL_FFLAGS_linux_ppc64le="-fopenmp -mcpu=power8 -mtune=power8 -fPIC -fstack-protector-strong -fno-plt -O3 -pipe"
FINAL_FFLAGS_linux_aarch64="-fopenmp -fPIC -fstack-protector-strong -fno-plt -O3 -pipe"
FINAL_FFLAGS_linux_s390x="-fopenmp -fPIC -fstack-protector-strong -fno-plt -O3 -pipe"
FINAL_FFLAGS_win_64="-fopenmp -fPIC -fstack-protector-strong -fno-plt -O3 -pipe"
...
FINAL_DEBUG_CFLAGS_linux_64="-march=nocona -mtune=haswell -fPIC -fstack-protector-all -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -ffunction-sections -pipe"
FINAL_DEBUG_CFLAGS_linux_ppc64le="-mcpu=power8 -mtune=power8 -fPIC -fstack-protector-all -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe"
FINAL_DEBUG_CFLAGS_linux_aarch64="-fPIC -fstack-protector-all -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe"
FINAL_DEBUG_CFLAGS_linux_s390x="-fPIC -fstack-protector-all -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe"
FINAL_DEBUG_CFLAGS_win_64="-fPIC -fstack-protector-all -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe"

FINAL_DEBUG_CXXFLAGS_linux_64="-fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -march=nocona -mtune=haswell -fPIC -fstack-protector-all -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -ffunction-sections -pipe"
FINAL_DEBUG_CXXFLAGS_linux_ppc64le="-fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -mcpu=power8 -mtune=power8 -fPIC -fstack-protector-all -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe"
FINAL_DEBUG_CXXFLAGS_linux_aarch64="-fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -fPIC -fstack-protector-all -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe"
FINAL_DEBUG_CXXFLAGS_linux_s390x="-fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -fPIC -fstack-protector-all -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe"
FINAL_DEBUG_CXXFLAGS_win_64="-fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -fPIC -fstack-protector-all -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe"

FINAL_DEBUG_FFLAGS_linux_64="-fopenmp -march=nocona -mtune=haswell -fPIC -fstack-protector-all -fno-plt -Og -g -Wall -Wextra -fcheck=all -fbacktrace -fimplicit-none -fvar-tracking-assignments -ffunction-sections -pipe"
FINAL_DEBUG_FFLAGS_linux_ppc64le="-fopenmp -mcpu=power8 -mtune=power8 -fPIC -fstack-protector-strong -pipe -Og -g -Wall -Wextra -fcheck=all -fbacktrace -fvar-tracking-assignments -pipe"
FINAL_DEBUG_FFLAGS_linux_aarch64="-fopenmp -fPIC -fstack-protector-strong -pipe -Og -g -Wall -Wextra -fcheck=all -fbacktrace -fvar-tracking-assignments -pipe"
FINAL_DEBUG_FFLAGS_linux_s390x="-fopenmp -fPIC -fstack-protector-strong -pipe -Og -g -Wall -Wextra -fcheck=all -fbacktrace -fvar-tracking-assignments -pipe"
FINAL_DEBUG_FFLAGS_win_64="-fopenmp -fPIC -fstack-protector-strong -pipe -Og -g -Wall -Wextra -fcheck=all -fbacktrace -fvar-tracking-assignments -pipe"
